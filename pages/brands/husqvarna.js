    ...
    return (<>
        ...
        <div className={styles.motos}>
            <div className={styles.h701}>
                ...
                <h3 className={styles.name}>701 Supermoto</h3>
            </div>
            <div className={styles.h450}>
                <img src="/huskyfs450.jpg" alt="FS 450" width={700} />
                <h3 className={styles.name}>FS 450</h3>
            </div>
        </div>
